...
HIDDEN_TAGS = ['mathjax','diary', 'pending', 'answer writing']
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; <a href="mailto:{email}"> {author} </a> - Powered by <a href="https://getnikola.com" rel="nofollow"> Nikola </a>{license}'
