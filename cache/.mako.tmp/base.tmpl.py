...
_magic_number = 10
_modified_time = 1602062913.0418937
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer('\n            <span class = "float-right">\n            <a href="https://twitter.com/nudgingheadsoc?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-size="large" data-show-screen-name="false" data-show-count="false">Follow @Hasanth Palanchu</a></span>\n        </footer>\n    </div>\n</div>\n\n')
